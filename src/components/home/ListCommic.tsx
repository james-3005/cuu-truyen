...
function ListCommic() {
  return (
    <section className='py-16 px-3 lg:py-24'>
      <h2 className='text-xl font-bold uppercase text-gray-700'>Mới cập nhật</h2>
        ...
        {Array(10)
          ...
          .map((_, index) => (
            <div className='flex' key={index}>
              ...
              />
              <div className='p-2'>
                <h4 className='mb-1 text-sm font-bold text-gray-800 line-clamp-2'>After GOD</h4>
      ...
      <div className='float-right mt-4 inline-block px-3'>
        <a href='#' className='flex items-center gap-1 text-sm font-bold text-gray-600 transition hover:text-blue-600'>
