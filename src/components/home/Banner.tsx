  ...
  return (
    <div className='flex flex-col'>
      <div
        ...
        style={{
          background: 'linear-gradient(132deg, rgb(213, 210, 208) 0%, rgb(27, 30, 37) 100%)'
        }}
      >
              ...
              .map((_, index) => (
                <SwiperSlide key={index} className=''>
                  <div className='relative h-full overflow-hidden rounded-lg'>
                    <img src='/src/assets/img-1.jpg' alt='' className='w-full' />
                        ...
                        <div className='absolute bottom-0 flex w-full items-center justify-between p-3  md:p-6'>
                          <div className='max-w-[90%] flex-1 md:max-w-[70%]'>
                            ...
                            <p className='text-sm font-light text-white text-opacity-80 line-clamp-2'>
                              Câu chuyện về Suzuki Iruma, một cậu bé bất hạnh bỗng cuộc đời xoay chuyển khi được Ác ma
                              Sullivan mang đến Ma Giới.
                            </p>
                          </div>
