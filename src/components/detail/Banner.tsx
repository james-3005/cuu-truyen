...
import img from "@/assets/green.svg";
function Banner() {
  return (
    <>
      <img src={img} className={styles.container} alt="123" />
      <div className="relative mt-[6rem]">
        <img
          src="/src/assets/mha-banner.jpg"
          alt=""
        ...
        <div className="bg-hero absolute top-0 h-full w-full">
          <div className="relative mx-auto h-full w-32 lg:w-full">
            ...
            <div className="absolute bottom-0 ml-[20rem] mt-20 hidden lg:mt-0 lg:block">
              <div className=" m-4">
                <h2 className="text-sm text-gray-200 text-opacity-75">
                  Horikoshi Kohei
                </h2>
                <h3 className="mt-1 text-2xl font-extrabold text-white">
                  My Hero Academia (FULL HD)
                </h3>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto mt-40 lg:ml-[20rem] lg:mt-0">
          <div className="m-4 mt-0 text-center lg:text-start">
            ...
            <p className="mb-4 text-justify text-gray-900">
              Câu chuyện kể về hành trình Deku trở thành anh hùng tuyệt vời
              nhất. Xem những thông tin mới nhất tại Fanpage:
              https://www.facebook.com/BnHAVN
            </p>
